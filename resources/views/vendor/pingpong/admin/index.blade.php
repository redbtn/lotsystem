...
<div class="row">
	<div class="col-lg-3 col-xs-6">
		...
		<div class="small-box bg-aqua">
			<div class="inner">
				<h3>
            {!! farmer()->count() !!} {{-- define function in Pingpong\Admin\helper.php --}}
				</h3>
			...
			<a href="{!! route('admin.farmers.index') !!}" class="small-box-footer">
...
{{--                 {!! Pingpong\Admin\Entities\Farm::Register-->count() !!} --}}
				</h3>

				<p>
					Jumlah Pohon Kelapa Dideres
				</p>
			</div>
			<div class="icon">
	...
	<section class="col-lg-7 connectedSortable">
		...
		<div class="nav-tabs-custom">
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="pull-left header"><i class="fa fa-inbox"></i> Revenue Penjualan</li>
			</ul>
...
{{-- 		<!-- Chat box -->
		<div class="box box-success">
			...
			<div class="box-body chat" id="chat-box">
				<!-- chat item -->
				<div class="item">
					<img src="{!! admin_asset('adminlte/img/avatar.png') !!}" alt="user image" class="online"/>
				...
				<!-- chat item -->
				<div class="item">
					<img src="{!! admin_asset('adminlte/img/avatar2.png') !!}" alt="user image" class="offline"/>
				...
				<!-- chat item -->
				<div class="item">
					<img src="{!! admin_asset('adminlte/img/avatar3.png') !!}" alt="user image" class="offline"/>
			...
			<div class="box-body">
				<ul class="todo-list">
					<li>
						...
						<!-- todo text -->
						<span class="text">Inspeksi Mendadak</span>
						<!-- Emphasis label -->
					...
					<li>
						...
						<input type="checkbox" value="" name=""/>
						<span class="text">Pendaftaran Petani</span>
					...
					<li>
						...
						<input type="checkbox" value="" name=""/>
						<span class="text">Export ke Eropa</span>
					...
					<li>
						...
						<input type="checkbox" value="" name=""/>
						<span class="text">Pembelian Oven</span>
					...
					<li>
						...
						<input type="checkbox" value="" name=""/>
						<span class="text">Pelatihan LOT System</span>
					...
					<li>
						...
						<input type="checkbox" value="" name=""/>
						<span class="text">Teknologi Baru Pembuatan Gula Semut</span>
					...
					<div class="box-footer no-border">
						<div class="row">
							<div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
								...
								<div class="knob-label">Organik</div>
							</div>
							<!-- ./col -->
							<div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
								<div id="sparkline-2"></div>
								<div class="knob-label">Konversi</div>
							</div>
							<!-- ./col -->
							<div class="col-xs-4 text-center">
								<div id="sparkline-3"></div>
								<div class="knob-label">Konvensional</div>
							</div>
							<!-- ./col -->
						</div>
						<!-- /.row -->
